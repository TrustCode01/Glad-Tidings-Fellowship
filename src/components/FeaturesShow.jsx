...
function FeaturesShow() {
  ...
  return (
    ...
    <div class="mx-auto flex max-w-[70rem] flex-col items-center space-y-4 text-center">
        ...
        <h2 class="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-6xl">Worship with us</h2>
    ...
    <motion.div class="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[70rem] md:grid-cols-3"
    ref={ref}
    initial="hidden"
    animate={controls}
    variants={container}>
